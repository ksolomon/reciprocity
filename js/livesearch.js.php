...
function liveSearchProcessReqChange() {
	...
	if (liveSearchReq.readyState == 4) {
		...
		res.firstChild.innerHTML = '<div id="searchcontrols" class="oddresult"><small>use the arrow keys & enter<br /><a href="javascript://" title="Close results" onclick="closeLiveSearch()">to close press esc</a><br /></div><div id="searchheader" style="display: none;"><strong><small>top 10 results</small></strong></div>'+liveSearchReq.responseText;
	}
}
