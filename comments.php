...
<?php foreach ($comments as $comment) : ?>
	...
	<img src="<?php bloginfo('template_directory'); ?>/images/commentheader.gif" /><strong><?php comment_author_link() ?></strong> <?php _e('said'); ?> <?php _e('on'); ?> <?php comment_date() ?> at <?php comment_time() ?>  <?php if ( $user_ID ) { ?><?php edit_comment_link(__("Edit This"), ' | '); ?><?php } ?>
	<?php comment_text() ?>
	</li>
...
<div id="loading" style="display: none;"><h2>Posting your comment.</h2></div>
<div id="errors"></div>
...
<!--
	Uncomment if you reallly want to show this to you users:
...
<h2><?php comments_rss_link(__('<abbr title="Really Simple Syndication">RSS</abbr> feed for comments on this post.')); ?> </h2><br />
